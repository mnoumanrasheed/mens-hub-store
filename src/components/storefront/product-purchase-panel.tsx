...
export function ProductPurchasePanel({ product, ordering, productUrl }: Props) {
  ...
  return <div className="atelier-purchase mt-8 grid gap-7"><ProductViewEvent productId={product.id} /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData).replace(/</g, "\\u003c") }} />
